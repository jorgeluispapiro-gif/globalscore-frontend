...
export function LoginPage() {
  ...
  return <main className="login-page">
    <section className="login-card" aria-labelledby="titulo-login">
      ...
      {!supabaseConfigurado && <Mensagem>O acesso não está disponível no momento. Procure o responsável pelo sistema.</Mensagem>}
      ...
      <footer>Acesso restrito a usuários autorizados</footer>
    </section>
    <div className="login-page__assinatura"><strong>MEASURE | COMPARE | ADVANCE</strong><span>GlobalScore</span></div>
  </main>;
}
