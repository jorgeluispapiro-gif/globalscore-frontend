...
export function RankingPanel({ dados = [], entidadeId, modoBase }) {
  ...
  if (!dados.length) return <EstadoVazio compacto titulo="Ranking ainda indisponível" descricao="A API ainda não oferece uma listagem de avaliações comparáveis para o período." />;
