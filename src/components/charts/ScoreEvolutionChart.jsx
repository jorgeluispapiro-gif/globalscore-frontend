...
export function ScoreEvolutionChart({ dados = [], eventos = [], indiceVisivel }) {
  if (dados.length < 2) return <EstadoVazio titulo="Não há avaliações suficientes para exibir a evolução" descricao="São necessários ao menos dois períodos avaliados para mostrar a evolução." />;
